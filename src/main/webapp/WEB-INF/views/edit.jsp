...
<body class="wrapper">
    ...
    <main>
        <form action="<%=request.getContextPath()%>/updBook" method="post" enctype="multipart/form-data" id="data_upload_form">
            <h1>書籍の編集</h1>
            <div class="content_body add_book_content">
                ...
                <div class="content_right">                     
                    <c:if test = "${!empty detailIsNull || !empty isbn || !empty pd}">
                       <div class ="error">                    
                           <p>${detailIsNull}</p>
                           <p>${isbn}</p>
                           <p>${pd}</p>
                    ...
                    <div>
                        <span>ISBM</span><span class="care care1">任意</span>
                        <c:if test="${!empty bookInfo}">
                    ...
                    <div>
                        ...
                        <c:if test="${!empty bookInfo}">
                            <input type="text" name="bio" value="${bookInfo.bio}">
                        </c:if>
                        <c:if test="${empty bookInfo}">
