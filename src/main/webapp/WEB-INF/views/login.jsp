        ...
        <div class="authorization">
            <div class="authorization_form">
                <form method="post" action="login">
                    ...
                    <label class="label">メールアドレス</label> <input type="text" class="input" name="email" id="email" autocomplete="off" required /> 
                    <label class="label">パスワード</label> <input type="password" class="input" id="password" name="password" required />
                    <c:if test="${!empty accountCheck}">
                        <div class="error">${accountCheck}</div>
                    </c:if> <input type="submit" class="button primary" value="ログイン" />
